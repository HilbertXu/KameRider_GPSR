...
private:
    ...
    {
        ifstream waypoints;
        waypoints.open("/home/kamerider/kamerider_GPSR/src/kamerider_navigation/gpsr_waypoints.txt", ios::out);
        string data, line;
        vector<string> str; 
...
public:
    int run(int argc, char** argv)
    {
        ...
        nav_pub    = nh.advertise<kamerider_control_msgs::Result>(pub_nav_result_topic_name, 1);
